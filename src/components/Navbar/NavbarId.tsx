...
export default function NavbarId({ direct_link_id, direct_link_en }: NavbarProps) {
  ...
  return (
    <nav className="navbar">
          ...
          <div className="left-navbar flex flex-row space-x-4 items-center">
            ...
            <div className="navbar-links flex flex-row items-center space-x-4 p-3 font-medium leading-[160%] text-base mt-2">
              <div className="navbar-link px-3">
                <Link to="/id/tentang">Tentang</Link>
              </div>
              ...
              <div className="navbar-link px-3 hover:cursor-pointer" onClick={toggleDropdown}>
                ...
                {/* Dropdown Paket Desktop */}
                {dropdown && (
                  <div className="dropdown-navbar__plans w-[250px] absolute z-[99]">
                    <ul className="ul bg-white p-4 shadow-md rounded-[10px]">
                      <Link to="/id/plans" className="p-2 flex flex-row items-center gap-3">
                      ...
                      <Link to="/id/plans/daily-coworking" className="p-2 flex flex-row items-center gap-3">
                        <div className="material-icons color-primary-blue-100">looks_one</div>
                        <p> Daily Coworking </p>
                      </Link>
                      <Link to="/id/plans/monthly-coworking" className="p-2 flex flex-row items-center gap-3">
                        <div className="material-icons color-primary-blue-100">date_range</div>
                        <p> Monthly Coworking </p>
                      </Link>
                      <Link to="/id/plans/dedicated-desk" className="p-2 flex flex-row items-center gap-3">
                        <div className="material-icons color-primary-blue-100">laptop_windows</div>
                        <p> Dedicated Desk </p>
                      </Link>
                      <Link to="/id/plans/private-office" className="p-2 flex flex-row items-center gap-3 hover:cursor-pointer">
                        <div className="material-icons color-primary-blue-100">vpn_key</div>
                        <p> Private Office </p>
                      </Link>
                      <Link to="/id/plans/meeting-room" className="p-2 flex flex-row items-center gap-3">
                        <div className="material-icons color-primary-blue-100">event_seat</div>
                        <p> Meeting Room </p>
                      </Link>

                      <Link to="/id/plans/event-space" className="p-2 flex flex-row items-center gap-3">
              ...
              <div className="navbar-link px-3">
                <Link to="/id/galeri">Galeri</Link>
              </div>

              <div className="navbar-link px-3">
                <Link to="/id/promo">Promo</Link>
              </div>

              <div className="navbar-link px-3">
                <Link to="/id/faq">FAQ</Link>
              </div>
            </div>
          </div>
          ...
          <div className="right-navbar">
            <div className="navbar-links flex flex-row items-center space-x-4 p-3 font-medium leading-[160%] text-base">
              <div className="navbar-link px-4 py-2 font-medium text-white primary-gradient-100 rounded-[6px]">
                <Link to="https://api.whatsapp.com/send?phone=6281511180600" target="_blank" rel="noopener noreferrer">
                  Hubungi Kami
                </Link>
              </div>
              {/* Change Language */}
              <div className="navbar-link rounded-[46px] flex bg-[#ECEFF4] p-1">
                {/* ID */}
                <Link to={direct_link_id} className="lang-id py-2 px-3 bg-[#FFFFFF] rounded-[102px]">
                  <img src="/images/icons/id.png" alt="indonesia" />
                </Link>

                {/* EN */}
                <Link to={direct_link_en} className="lang-en py-2 px-3">
      ...
      {/* Mobile */}
      <div className="bg-white border-gray-200 block md:hidden">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex items-center md:order-2">
            <button
              ...
              className="inline-flex items-center font-medium justify-center gap-3 px-4 py-2 text-sm text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <div className="rounded-3xl">
                <img src="/images/language/lang-id.png" alt="" style={{ imageRendering: 'pixelated' }} />
              </div>
              Indonesia
            </button>
            ...
            {navbarLangMobile && (
              <div className="z-50 absolute top-[50px] my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow" id="language-dropdown-menu">
                <ul className="py-2 font-medium" role="none">
                  <li>
                    <Link to={direct_link_en} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                      <div className="inline-flex items-center gap-3">
                        <img src="/images/language/lang-en.png" alt="" style={{ imageRendering: 'pixelated' }} />
                        English
                      </div>
                    </Link>
                  </li>
          ...
          {navbarMobile && (
            <div className="items-center justify-between w-full md:w-auto">
              <ul className="flex flex-col font-medium md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
                <Link className="block py-2 pl-3 pr-4" to="/">
                  Beranda
                </Link>
                <Link className="block py-2 pl-3 pr-4" to="/id/tentang">
                  Tentang
                </Link>
                ...
                {dropdownPlansMobile && (
                  <div className="dropdown-plans">
                    <Link className="block py-2 pl-6 pr-4" to="/id/plans">
                      Gambaran Paket
                    </Link>
                    <Link className="block py-2 pl-6 pr-4" to="/id/plans/daily-coworking">
                      Daily Coworking
                    </Link>
                    <Link className="block py-2 pl-6 pr-4" to="/id/plans/monthly-coworking">
                      Monthly Coworking
                    </Link>
                    <Link className="block py-2 pl-6 pr-4" to="/id/plans/dedicated-desk">
                      Dedicated Desk
                    </Link>
                    <Link className="block py-2 pl-6 pr-4" to="/id/plans/private-office">
                      Private Office
                    </Link>
                    <Link className="block py-2 pl-6 pr-4" to="/id/plans/meeting-room">
                      Meeting Room
                    </Link>
                    <Link className="block py-2 pl-6 pr-4" to="/id/plans/event-space">
                      Event Space
                    </Link>
                  </div>
                )}

                <Link className="block py-2 pl-3 pr-4" to="/id/galeri">
                  Galeri
                </Link>

                <Link className="block py-2 pl-3 pr-4" to="/id/promo">
                  Promo
                </Link>

                <Link className="block py-2 pl-3 pr-4" to="/id/faq">
                  FAQ
                </Link>
              </ul>
            </div>
